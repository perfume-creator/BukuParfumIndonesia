                ...
                <div data-tab-content="history" id="tab-panel-history" role="tabpanel" aria-labelledby="tab-history"
                    ...
                    <figure
                        ...
                        <img src="/images/ns-img-576.png"
                            alt="Dasar Kimia Parfum" class="size-full object-cover"
                            loading="lazy">
                    </figure>
                    ...
                    <div
                        ...
                        <div class="space-y-12 xl:space-y-39">
                            <div class="max-w-[547px] space-y-2 text-center md:text-left">
                                ...
                                <p class="line-clamp-4 lg:line-clamp-none">
                                    Pelajari struktur molekul aroma, reaksi kimia di balik ekstraksi bahan baku,
                                    serta sains yang menjelaskan mengapa parfum berbau unik dan bagaimana mereka
                                    berinteraksi dengan kulit Anda. (Segera Hadir)
                                </p>
                            </div>
